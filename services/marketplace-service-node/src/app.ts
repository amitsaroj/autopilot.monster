...
export async function createApp(): Promise<FastifyInstance> {
  ...
  await app.register(swagger, {
    openapi: {
      ...
      info: {
        ...
        description: 'Product catalog and marketplace',
        version: '1.0.0',
      },
  ...
  app.get('/health', async () => {
    const dbHealth = getDatabaseHealth('marketplace-service');
  ...
  // Register routes
  const marketplaceRoutes = (await import('./routes/marketplace.routes')).default;
